...
| [`bike_sharing_timeseries.ipynb`](bike_sharing_timeseries.ipynb) | OpenML Bike_Sharing_Demand (17k rows) | expanding-window CV; **two** baselines (marginal + lag-24 seasonal); 8-model leaderboard |
