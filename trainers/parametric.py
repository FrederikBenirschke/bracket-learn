...
EMOS, HeteroscedasticNormal, NGBoostNormal, MixtureNormals, BayesianRidge,
HierarchicalNormal (parametric normal / mixture / Student-t). The parametric
meta-learners that combine *upstream* forecasts (StackedParametric,
BMAStacking) live in ``bracketlearn.trainers.combiners``.
"""
